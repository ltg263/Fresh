...
/**
 * 使得CommonIndicator在FragmentContainer中使用
 */

@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public class FragmentContainerHelper {
    private List<CommonIndicator> mMagicIndicators = new ArrayList<CommonIndicator>();
    ...
    public FragmentContainerHelper(CommonIndicator magicIndicator) {
    ...
    public void attachMagicIndicator(CommonIndicator magicIndicator) {
        mMagicIndicators.add(magicIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (CommonIndicator magicIndicator : mMagicIndicators) {
