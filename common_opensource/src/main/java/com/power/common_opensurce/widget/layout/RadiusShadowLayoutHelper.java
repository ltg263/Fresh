package com.power.common_opensurce.widget.layout;
...
public class RadiusShadowLayoutHelper implements RadiusShadowLayout {
    ...
    private int mRadius;
    private @RadiusShadowLayout.HideRadiusSide int mHideRadiusSide = HIDE_RADIUS_SIDE_NONE;
    ...
    private int mShadowColor = Color.parseColor("#ff0000ff");
    ...
    public RadiusShadowLayoutHelper(Context context, AttributeSet attrs, int defAttr, View owner) {
        this(context, attrs, defAttr, 0, owner);
    }

    public RadiusShadowLayoutHelper(Context context, AttributeSet attrs, int defAttr, int defStyleRes, View owner) {
        mContext = context;
        mOwner = new WeakReference<>(owner);
        mBottomDividerColor = mTopDividerColor =Color.parseColor("#f2f2f2");
        ...
        if (shadow == 0 && useThemeGeneralShadowElevation) {
            shadow = PublicUtil.dip2px(context,14);

        }
        Log.i("TESTRadiusAndShadow", "RadiusShadowLayoutHelper: radius"+radius+" mHideRadiusSide"+mHideRadiusSide+" shadow="+shadow+" mShadowAlpha="+mShadowAlpha);
        setRadiusAndShadow(radius, mHideRadiusSide, shadow, mShadowAlpha);
    }

    @Override
    public void setUseThemeGeneralShadowElevation() {
        mShadowElevation = PublicUtil.dip2px(mContext,14);
    ...
    @Override
    public void setRadius(int radius, @RadiusShadowLayout.HideRadiusSide int hideRadiusSide) {
    ...
    @Override
    public void setRadiusAndShadow(int radius, @RadiusShadowLayout.HideRadiusSide int hideRadiusSide, int shadowElevation, float shadowAlpha) {
