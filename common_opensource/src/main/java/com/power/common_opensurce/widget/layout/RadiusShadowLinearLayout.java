...
import com.power.common_opensurce.widget.alpha.CommonAlphaLinearLayout;

/**
 */

public class RadiusShadowLinearLayout extends CommonAlphaLinearLayout implements RadiusShadowLayout {
    private RadiusShadowLayoutHelper mLayoutHelper;

    public RadiusShadowLinearLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public RadiusShadowLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public RadiusShadowLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new RadiusShadowLayoutHelper(context, attrs, defStyleAttr, this);
    ...
    @Override
    public void setRadiusAndShadow(int radius, @RadiusShadowLayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @RadiusShadowLayoutHelper.HideRadiusSide int hideRadiusSide) {
