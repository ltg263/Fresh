package com.power.common_opensurce.widget.ratingstar;
...
public class RatingStarView extends View implements View.OnClickListener{
    ...
    private boolean drawStrokeForFullStar = false;
    private boolean drawStrokeForHalfStar = false;
    private boolean drawStrokeForEmptyStar = false;
    private boolean enableSelectRating = false;
    private boolean onlyHalfStar = false;
    ...
    public int getStarNum() {
        Log.e("jsc", "RatingStarView-getStarNum:"+rating);
        return starCount;
    }
    ...
    private void loadAttributes(AttributeSet attrs, int defStyle) {
        ...
        drawStrokeForEmptyStar = a.getBoolean(R.styleable.RatingStarView_rsv_drawStrokeForEmptyStar, drawStrokeForEmptyStar);
        drawStrokeForFullStar = a.getBoolean(R.styleable.RatingStarView_rsv_drawStrokeForFullStar, drawStrokeForFullStar);
        drawStrokeForFullStar = a.getBoolean(R.styleable.RatingStarView_rsv_drawStrokeForHalfStar, drawStrokeForFullStar);
        enableSelectRating = a.getBoolean(R.styleable.RatingStarView_rsv_enableSelectRating, enableSelectRating);
        onlyHalfStar = a.getBoolean(R.styleable.RatingStarView_rsv_onlyHalfStar, onlyHalfStar);
        a.recycle();
    }
    ...
    private void drawPartialStar(StarModel star, Canvas canvas, float percent) {
        ...
        // layer 2 单独定义一个与星星等大的图层画布图层，后面的所用操作均在改图层进行绘制，直到调用canvas.restore()
